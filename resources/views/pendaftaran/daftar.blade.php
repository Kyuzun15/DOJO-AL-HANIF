        ...
        <form action="/daftar" method="POST">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="berat_badan" value="{{ old('berat_badan') }}" required placeholder="Contoh: 45">
                </div>
                <div class="form-group">
                    <label>Tinggi Badan (Cm)</label>
                    <input type="number" name="tinggi_badan" value="{{ old('tinggi_badan') }}" required placeholder="Contoh: 150">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="alamat" rows="3" required placeholder="Jalan, RT/RW, Kelurahan, Kecamatan...">{{ old('alamat') }}</textarea>
            </div>
