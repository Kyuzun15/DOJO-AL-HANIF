            ...
            <form action="/admin/pengurus/{{ $pengurus->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                    <div style="flex: 1;">
                        ...
                        <select name="kode_jabatan" class="form-input" required>
                            ...
                            <option value="bimbingan_prestasi" {{ old('kode_jabatan', $pengurus->kode_jabatan) == 'bimbingan_prestasi' ? 'selected' : '' }}>BIMBINGAN PRESTASI</option>
                            <option value="bidang_usaha" {{ old('kode_jabatan', $pengurus->kode_jabatan) == 'bidang_usaha' ? 'selected' : '' }}>BIDANG USAHA</option>
                            <option value="ukt_gasuku" {{ old('kode_jabatan', $pengurus->kode_jabatan) == 'ukt_gasuku' ? 'selected' : '' }}>UKT & GASUKU</option>
                        </select>
                ...
                <div style="display: flex; gap: 15px; margin-bottom: 15px;">
                    ...
                    <div style="flex: 1;">
                        ...
                        <input type="text" name="sub_jabatan" class="form-input" value="{{ old('sub_jabatan', $pengurus->sub_jabatan) }}">
                    </div>
                    <div style="flex: 1;">
